...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        $so_luong_nha_cung_cap = NhaCungCap::count();
        ...
        return view('dashboard', compact('so_luong_hang_hoa', 'so_luong_loai_hang', 'so_luong_het_hang', 'tien_nhap_kho', 'tien_xuat_kho', 'lai', 'doanh_thu','so_luong_nha_cung_cap'));
    }
    ...
    public function Tongchi()
    {
        ...
        $monthColumn = 'MONTH(created_at)';

        $tc = ChiTietHangHoa::selectRaw($monthColumn . ' as month, SUM(so_luong_goc * gia_nhap) as tc')
