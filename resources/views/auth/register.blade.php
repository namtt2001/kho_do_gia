                        ...
                        <div class="row gy-3">
                            ...
                            <div class="col-12">
                                <div class="form-group"><label for="sdt" class="form-label">Số Điện Thoại</label>
                                    <div class="form-control-wrap"><input id="sdt" type="text" class="form-control" name="sdt"
                                            required placeholder="số điện thoại.."></div>
                            ...
                            <div class="col-12">
                                <div class="form-group"><label for="dia_chi" class="form-label">Địa chỉ</label>
                                    <div class="form-control-wrap"><input id="dia_chi" type="text" class="form-control" name="dia_chi"
                                            required placeholder="Địa chỉ..."></div>
