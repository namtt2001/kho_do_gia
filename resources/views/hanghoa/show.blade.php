        ...
        <div class="container">
            <div class="nk-content-inner">
                <div class="nk-content-body">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-5"><img src="{{ asset('uploads') }}/{{ $hang_hoa->img }}" alt="{{ $hang_hoa->ten_hang_hoa }}"
            ...
            <li><button type="submit" class="btn btn-primary"><a href="{{ url()->previous() }}" class="btn border-0">Quay
                lại</a>
        </li>
        </div>
    </div>
